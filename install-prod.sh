...
get_config() {
	...
	download https://raw.githubusercontent.com/bendover96/listmonk/master/config.toml.sample config.toml
}

get_containers() {
	info "fetching docker-compose.yml from listmonk repo"
	download https://raw.githubusercontent.com/bendover96/listmonk/master/docker-compose.yml docker-compose.yml
}
